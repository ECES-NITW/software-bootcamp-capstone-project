...
const Chat = ({ conversationId }) => {
  ...
  const addMessage = (msg) => {
    queryClient.setQueryData(["chat_messages", conversationId], (prev = []) => {
  ...
  const renderOffer = (msg, isMe, key) => {
    ...
    return (
      ...
      >
        ...
        {status === "none" && isMe && (
          <div className="offerStatusBar offer-pending">Awaiting response…</div>
        )}
        {status === "accepted" && (
          <div className="offerStatusBar offer-accepted">✓ Offer Accepted</div>
        )}
        {status === "declined" && (
          <div className="offerStatusBar offer-declined">✕ Offer Declined</div>
        )}
      </div>
    );
  };
    ...
    <>
      ...
      {optionCard === "offer" && (
        <div className="offerComposer">
          <div className="offerComposerTitle">Negotiate with a new price</div>
